...
from libs.SeparableConvolutionLayer import SeparableConvolutionLayer
...
class Net(nn.Module):
    ...
    def __init__(self, init_weights=True):
        ...
        self.separable_conv = SeparableConvolutionLayer.apply
    ...
    def _check_gradients(func):
        ...
        test = gradcheck(func, inputs, eps=1e-2, atol=1e-2, raise_exception=True)
