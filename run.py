...
from libs import SeparableConvolutionModule# the custom SeparableConvolution layer
...
arguments_strOut = './images/result.png'
arguments_strVideo = ''
...
class Network(torch.nn.Module):
	...
	def forward(self, variableInput1, variableInput2):
		...
		variableDot1 = SeparableConvolutionModule()(self.modulePad(variableInput1), self.moduleVertical1(variableCombine), self.moduleHorizontal1(variableCombine))
		variableDot2 = SeparableConvolutionModule()(self.modulePad(variableInput2), self.moduleVertical2(variableCombine), self.moduleHorizontal2(variableCombine))
